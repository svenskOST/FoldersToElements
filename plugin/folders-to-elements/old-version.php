...
function foldersToElements($atts)
{
   ...
   if (isset($program)) {
      ...
      foreach ($folders as $folder) {
         ...
         $elements .= "
            <a href='$link' target='_blank' class='wp-block-column is-layout-flow wp-block-column-is-layout-flow' style='background-color: rgba(0, 0, 0, 0.5); border-radius: 30px; display: flex; justify-content: center; align-items: center; flex-direction: column; padding: 50px 20px; margin: 2vh 1vw; text-decoration: none;'>
